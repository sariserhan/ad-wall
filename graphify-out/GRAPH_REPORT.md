...
## Corpus Check
- 250 files · ~463,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1545 nodes · 2237 edges · 114 communities (101 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba34cf8e`
...
Cohesion: 0.08
Nodes (26): BundleCity, businessCardShapeOptions, clearImagesFromIDB(), ComposerForm, countries, defaultStates, DetailField, detailFieldLabels (+18 more)
...
Cohesion: 0.10
Nodes (18): catalog, buildPlaygroundCsvTemplate(), COUNTRY_ALIASES, CSV_ALLOWED_HEADERS, CSV_OPTIONAL_HEADERS, CSV_REQUIRED_HEADERS, csvMaybeInteger(), csvMaybeNumber() (+10 more)
...
Cohesion: 0.22
Nodes (13): BackCardPreview(), ComposerProps, EditCardModal(), shapeLabels, themeLabels, PlacementMode(), PlacementModeProps, CardDraft (+5 more)
...
Cohesion: 0.21
Nodes (14): OwnerDashboard, OwnerDashboardProps, renewalOptions, businessCardFormats, businessCardShapes, CardUpdate, CreateCard, CreateCardRateLimit (+6 more)

### Community 107 - "Community 107"
Cohesion: 0.22
Nodes (10): hashStr(), wallCardStyle(), WallCardVars, Composer(), WallApp(), activeFilterCount(), FeaturedTierOption, FeaturedTierValue (+2 more)
...
## Knowledge Gaps
- **846 isolated node(s):** `When to Use`, `When Not to Use`, `Workflow`, `Choose the Shape`, `Default Approach` (+841 more)
...
- **What connects `When to Use`, `When Not to Use`, `Workflow` to the rest of the system?**
