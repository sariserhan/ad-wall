...
## Corpus Check
- 232 files · ~444,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1536 nodes · 2226 edges · 122 communities (108 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7768730b`
...
Cohesion: 0.09
Nodes (24): BundleCity, businessCardShapeOptions, clearImagesFromIDB(), Composer(), countries, defaultStates, DetailField, detailFieldLabels (+16 more)
...
Cohesion: 0.08
Nodes (33): DurableRateLimitScope, durableUserRateLimit(), observe(), buckets, isSameOriginRequest(), pruneBuckets(), rateLimit(), handleCheckout() (+25 more)
...
Cohesion: 0.09
Nodes (24): metadata, AnalyticsConsent, AnalyticsConsentContext, AnalyticsConsentContextValue, AnalyticsConsentProvider(), useAnalyticsConsent(), AnalyticsConsentToast(), AnalyticsTracker() (+16 more)
...
Cohesion: 0.06
Nodes (19): BULK_CATEGORIES, BULK_COUNTS, BULK_LINES, BULK_NAMES, BULK_THEMES, CreateCardSection(), CSV_ALLOWED_HEADERS, CSV_REQUIRED_HEADERS (+11 more)
...
Cohesion: 0.11
Nodes (17): recordLogin, reportBug, sendContactMessage, getMyReview, listForCard, remove, upsert, isSaved (+9 more)
...
Cohesion: 0.08
Nodes (25): dependencies, @clerk/nextjs, @clerk/ui, convex, country-state-city, exceljs, @fontsource/barlow-condensed, @fontsource/caveat (+17 more)
...
Cohesion: 0.18
Nodes (8): AppProvidersProps, GlobalContactModal(), GlobalOwnerDashboard(), openContact(), pushContactHandler(), stack, ClerkContactUser, ContactPage()
...
Cohesion: 0.43
Nodes (5): ContactLink(), fetchTopCards(), fetchTopWalls(), metadata, TrendingPage()
...
Cohesion: 0.16
Nodes (15): ComposerForm, shapeLabels, themeLabels, ImageSwapViewer(), ImageSwapViewerProps, businessCardFormats, BusinessCardShape, businessCardShapes (+7 more)
...
Cohesion: 0.19
Nodes (10): openDashboard(), pushDashboardHandler(), stack, allowedImageTypes, createImageVariants(), encodeWebpVariant(), ImageVariants, CreateCardRateLimit (+2 more)

## Knowledge Gaps
- **855 isolated node(s):** `npx`, `Props`, `Props`, `Props`, `Props` (+850 more)
...
- **Why does `api` connect `Geo-Routed Pages & RSS Feeds` to `Billing, Admin & Test Infrastructure`, `Community 34`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 106`, `Community 11`, `Community 46`, `Community 81`, `Community 17`, `Community 56`, `Community 57`, `Community 120`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `WallCard` connect `Community 72` to `Billing, Admin & Test Infrastructure`, `Community 7`, `Community 107`, `Community 46`, `Community 81`, `Community 23`, `Community 120`?**
