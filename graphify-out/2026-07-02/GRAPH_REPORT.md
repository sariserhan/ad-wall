...
## Corpus Check
- 254 files · ~466,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1815 nodes · 2527 edges · 132 communities (119 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36445b72`
...
- `generateMetadata()` --calls--> `parseCityFromSlug()`  [INFERRED]
  app/[country]/[state]/[city]/[category]/page.tsx → src/lib/wall-slug-server.ts
...
Cohesion: 0.08
Nodes (30): BundleCity, businessCardShapeOptions, clearImagesFromIDB(), Composer(), ComposerForm, countries, defaultStates, DetailField (+22 more)
...
Cohesion: 0.06
Nodes (38): metadata, bundleCard, bundleCities, crons, adminEnv, adminIdentity, applyEnv(), makeT() (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (29): ClerkAvatarMenu(), ClerkAvatarMenuProps, ClerkProfile, HomeNav(), HomePostButton(), Loc, captureAnalytics(), actionBtn (+21 more)

### Community 4 - "Community 4"
Cohesion: 0.14
Nodes (11): AdminPanel, GlobalAdminPanel(), openAdminPanel(), pushAdminHandler(), stack, AdminDashboardData, AdminPanelProps, AdminPlayground() (+3 more)
...
Cohesion: 0.08
Nodes (33): DurableRateLimitScope, durableUserRateLimit(), observe(), buckets, isSameOriginRequest(), pruneBuckets(), rateLimit(), buildRedirectUrl() (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (67): GET(), Props, GET(), GET(), NotFound(), BASE_URL, CITY_PATHS, sitemap() (+59 more)
...
Cohesion: 0.08
Nodes (28): metadata, AnalyticsConsent, AnalyticsConsentContext, AnalyticsConsentContextValue, AnalyticsConsentProvider(), useAnalyticsConsent(), AnalyticsConsentToast(), AnalyticsTracker() (+20 more)
...
Cohesion: 0.13
Nodes (12): seedCards, Composer, defaultSeedLocation, DetailPanel, OwnerDashboard, PlacementMode, WallApp(), activeFilterCount() (+4 more)
...
Cohesion: 0.17
Nodes (14): BackCardPreview(), ComposerProps, EditCardModal(), PlacementMode(), PlacementModeProps, CardDraft, getCardFormat(), getImageCardFormat() (+6 more)
...
Cohesion: 0.14
Nodes (21): OwnerDashboard, shapeLabels, themeLabels, OwnerDashboardProps, renewalOptions, businessCardFormats, cardFormats, cardThemes (+13 more)

### Community 106 - "Community 106"
Cohesion: 0.08
Nodes (27): recordLogin, reportBug, sendContactMessage, getMyReview, listForCard, remove, upsert, ensureActiveUser() (+19 more)
...
Cohesion: 0.25
Nodes (7): HomeHowItWorksModal(), STEPS, browseCategories, newThisWeek, popularWalls, recentPosts, spotlightCards
...
Cohesion: 0.26
Nodes (9): metadata, Props, RootPage(), HomePage(), fetchIsAdmin(), fetchTopCards(), fetchTopWalls(), metadata (+1 more)
...
Cohesion: 0.25
Nodes (8): hashStr(), wallCardStyle(), WallCardVars, CreateCardSection(), getSubcategoriesForCategory(), FeaturedTierOption, featuredTierWeight(), getVisibleFeaturedTierOptions()
...
## Knowledge Gaps
- **1062 isolated node(s):** `npx`, `Props`, `Props`, `Props`, `Props` (+1057 more)
...
- **Why does `api` connect `Geo-Routed Pages & RSS Feeds` to `Billing, Admin & Test Infrastructure`, `Community 34`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 75`, `Community 11`, `Community 112`, `Community 81`, `Community 17`, `Community 57`, `Community 125`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `WallCard` connect `Community 81` to `Community 64`, `Billing, Admin & Test Infrastructure`, `Community 3`, `Community 7`, `Community 23`?**
