    ...
    <main className="legal-page">
      ...
      <div className="legal-page__body">
        ...
        <section>
          ...
          <p>Public card information is shared on the wall by design. Non-public information may be shared with service providers that support hosting, authentication, storage, analytics, or payment processing, and may also be disclosed where required by law or to protect the platform and its users.</p>
        </section>
        <section>
          <h2>7. Retention</h2>
        ...
        <section>
          ...
          <p>You may be able to update or remove certain card information through your account tools. You can also limit the information you choose to publish, especially contact details and optional social links.</p>
        </section>
        <section>
          <h2>9. Security</h2>
